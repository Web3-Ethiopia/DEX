...
//         uint256 contractBalanceBefore = IERC20(_tokenOut).balanceOf(
//             address(this)
//         );
...
//         uint256 contractBalanceAfter = IERC20(_tokenOut).balanceOf(
//             address(this)
//         );
//         // console.log("Contract balance of output token after swap:", contractBalanceAfter);

//         require(
//             contractBalanceAfter >= amountOut,
//             "Contract does not have enough output tokens"
//         );
...
//         ILiquidityPool(allPoolManager.fetchLiquidityPoolAddress(_poolName))
//             .changeReserveThroughSwap(
//                 _poolName,
//                 _tokenIn,
//                 _amountIn,
//                 address(this)
...
//     ) external {
//         require(
//             _poolNames.length == _tokensIn.length,
...
//         );
//         require(
//             _tokensOut.length == _amountsIn.length,
//             "Mismatched input lengths"
//         );
//         require(
//             _amountsIn.length == _amountsOutMin.length,
//             "Mismatched input lengths"
//         );

//         for (uint256 i = 0; i < _poolNames.length - 1; i++) {
//             require(
//                 allPoolManager.isMultiHopSwapPossible(
//                     _poolNames[i],
//                     _poolNames[i + 1]
//                 ),
//                 "Multi-hop swap not possible"
//             );
//         }
...
//         ILiquidityPool(allPoolManager.fetchLiquidityPoolAddress(_poolNames[i]))
//             .changeReserveThroughSwap(
//                 _poolNames[i],
//                 _tokensIn[i],
//                 _amountsIn[i],
...
//         require(
//             totalAmountOut >= _amountsOutMin[_amountsOutMin.length - 1],
